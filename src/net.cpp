...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Oceancoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"oceancoin.com", "217.182.226.18"},
	{"217.182.226.18", "217.182.226.18"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"oceancointools.com", "testnet-seed.oceancointools.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Oceancoin is probably already running."), addrBind.ToString().c_str());
        else
